...
async def message_status(text):
    try:
        await soheru.edit_message_text(MAIN_CHANNEL, message_id=MESSAGE_ID, text=text, reply_markup=IKM([[IKB(text_replace('Dev'), url='https://t.me/Officialcreater'), IKB(text_replace('Files'), url=f"https://t.me/Ongoing_Anime_Bash")]]))
